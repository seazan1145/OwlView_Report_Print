...
class OwlViewApp:
    ...
    def open_detail_settings(self) -> None:
        ...
        ttk.Label(sec_print, text="inputtable上で再入力切替").grid(row=6, column=0, sticky="w", padx=4, pady=2)
        ttk.Checkbutton(sec_print, variable=vars["inputtable_switch"]).grid(row=6, column=1, sticky="w")
